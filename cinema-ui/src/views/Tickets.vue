      ...
      <form class="row g-3">
        ...
        <div class="col-md-4">
          ...
          <div class="input-group">
            ...
            <input type="text" v-model="client.email" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required>
          </div>
        </div>
        <div class="col-md-3">
...
<style scoped>
#tickets{
  background-image: url("https://p0.pikist.com/photos/964/557/clapper-hollywood-cinema-board-production-clapperboard-video-director-clapboard.jpg ");
}
</style>
